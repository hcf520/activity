package com.hcf.activity.config.mybatis.generator;
...
//    gc.setOutputDir(projectPath + "/src/main/java");
    ...
    dsc.setUrl("jdbc:mysql://localhost:3306/user?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
    ...
    pc.setParent("com.hcf.activity");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
